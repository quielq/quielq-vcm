...
Usage:
    python scripts/demo_infer.py --checkpoint checkpoints/dscnn_bigcap_timers_best.pt
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", type=Path, default=Path("checkpoints/dscnn_bigcap_timers_best.pt"))
