...
[EXPERIMENTS.md](EXPERIMENTS.md)** for real training-run results (first
baseline: DS-CNN, 65.29% val accuracy) and **[MODEL.md](MODEL.md)** for
the technology choices and research behind the training pipeline.
